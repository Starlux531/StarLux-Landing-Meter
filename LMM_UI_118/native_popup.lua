-- StarLux LMM 1.1.8beta: SDK 440 Panel Graphics host for FlyWithLua/LuaJIT.
...
function M:present(frame)
    ...
    local x, y = frame.position(sw, sh, self.layout.width, self.layout.height)
...
function M:initialize(options)
    ...
    spec.handleMouseClickFunc = keep("LMM118_Mouse", function() return 0 end)
    spec.handleRightClickFunc = spec.handleMouseClickFunc
