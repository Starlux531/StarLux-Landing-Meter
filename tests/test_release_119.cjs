...
assert(!/<details\b/i.test(readme),'gallery must be expanded');
for(const name of ['lmm-119-full-flight-analysis.png','lmm-119-touchdown-plan-en.png'])assert(readme.includes('docs/images/'+name)&&fs.existsSync(path.join(root,'docs/images',name)));
