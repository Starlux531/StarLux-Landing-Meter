-- StarLux 落地率插件 v0.8.1 测试版
-- 适用于 X-Plane 12 + FlyWithLua
-- v0.8.1 新增逐样本数学审计记录，使报告中的核心结果可以独立复算。
...
local function write_landing_log()
    ...
    file:write("StarLux 落地率插件 v0.8.1 - 单次落地记录\n")
    file:write("======================================================================\n\n")
    ...
    file:write("评分说明: v0.8.1 测试阶段的拉平曲率不参与评分。\n")
...
if logMsg then
    logMsg(string.format(
        "[StarLux LMM] v0.8.1 loaded successfully with %d direct XPLM DataRefs.",
        #LMM_DATAREF_SPECS
    ))
end
